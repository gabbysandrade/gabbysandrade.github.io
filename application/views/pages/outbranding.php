...
<section class="shade-light">
    <div class="container bodydiv py-5 txt-light1">
        <h1 class="overview-title">OutBranding Promos</h1>
    ...
    <div class="container bodydiv py-5 txt-dark">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-5 offset-md-1 text-center detail-text">
                ...
                <p>In this redesign, we reframed the vector graphics as highlights rather than the central style in favor of product and team member photos to achieve 
                a more sleek and professional look that better answers the question, “What can customers expect when they select OutBranding Promos as their 
                promotional product service?”</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="diskholder row align-items-center">
            <div class="col-12 col-md-6">
                <div class="row align-items-center">
                    ...
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-title="#177D2A" data-bs-content="Used in headings, button hovers, and graphics."/>
                </div>
                <div class="row align-items-center">
                    <img class="colordisk" id="obp5" src="assets/images/colordisks/colordisk_obp5.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-title="#8CDD9B" data-bs-content="Used as an accent color in graphics."/>
                    <img class="colordisk" id="obp1" src="assets/images/colordisks/colordisk_obp1.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-title="#1EB53A" data-bs-content="Used in logo, headings, buttons, and links."/>
                    <img class="colordisk" id="obp4" src="assets/images/colordisks/colordisk_obp4.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-title="#68CF80" data-bs-content="Used as an accent color in graphics."/>
                </div>
                <div class="row align-items-center">
                    <img class="colordisk mx-auto" id="obp6" src="assets/images/colordisks/colordisk_obp6.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-title="#E1F6E5" data-bs-content="Used as a background or highlight color for icons and other graphics."/>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="row align-items-center">
                    <img class="colordisk mx-auto" id="obp7" src="assets/images/colordisks/colordisk_obp7.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-title="#024E84" data-bs-content="Used in headings, button hovers, paragraph text, backgrounds, and graphics."/>
                </div>
                <div class="row align-items-center">
                    <img class="colordisk" id="obp8" src="assets/images/colordisks/colordisk_obp8.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-title="#2E87C6" data-bs-content="Used in backgrounds and as an accent color in graphics."/>
                    <img class="colordisk" id="obp2" src="assets/images/colordisks/colordisk_obp2.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-title="#0074C6" data-bs-content="Used in logo, headings, buttons, links, and backgrounds."/>
                    <img class="colordisk" id="obp9" src="assets/images/colordisks/colordisk_obp9.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-title="#69B0E1" data-bs-content="Used in toggles and as an accent color in graphics."/>
                </div>
                <div class="row align-items-center">
                    <img class="colordisk mx-auto" id="obp10" src="assets/images/colordisks/colordisk_obp10.png" 
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-title="#D2E8F8" data-bs-content="Used as a background or highlight color in graphics."/>
                </div>
            </div>
        </div>
    </div>
